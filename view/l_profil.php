...
error_reporting(0);
 ...
 $query = $db->prepare("SELECT t_pelanggan.*, t_user.* from t_pelanggan, t_user where t_pelanggan.id_pelanggan='$id'");
 $query->execute();
...
<div class="panel-body">
	...
	<form class="form-horizontal"  method="post">	  
	  ...
	  {
	      $act = $db->prepare("UPDATE t_setting SET nama = '".$_POST['nama']."', alamat = '".$_POST['alamat']."', pemilik = '".$_POST['pemilik']."' WHERE id = '1'");
	      $act->execute();
