...
error_reporting(0);
 ...
 $query = $db->prepare("SELECT t_pelanggan.*, t_paket.nama as nama_paket, t_paket.harga from t_pelanggan left join t_paket on t_pelanggan.id_paket=t_paket.id_paket where t_pelanggan.id_pelanggan='$_GET[id]'");
 $query->execute();
