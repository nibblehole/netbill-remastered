...
error_reporting(0);
  ...
  $perusahaan = $db->prepare("SELECT * FROM t_setting limit 1");
  $perusahaan->execute();
  $seting = $perusahaan->fetch(PDO::FETCH_ASSOC);    
  $_SESSION['level'];
...
<head>
  ...
  <meta name="description" content="Internet Billing Apps">
  ...
  <title>Aplikasi Tagihan Internet - TeamX Project</title>
...
<div id="wadah">
  ...
  <div id="ekor">
  Copyright &copy; <?php echo date('Y'); ?> by <a href="http://surdaysoft.com" target="_blank" title="SurdaySoft"> Surday Soft</a>. Reworked by <a href="https://teamxproject.online" target="_blank" title="TeamX Project"> TeamX Project</a>.
  </div>
</div>
